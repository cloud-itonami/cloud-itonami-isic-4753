...
- `test/flooringops/governor_test.cljk` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/flooringops/advisor_test.cljk` -- advisor proposal shape and
  consistency
- `test/flooringops/phase_test.cljk` -- rollout phase logic
- `test/flooringops/governor_contract_test.cljk` -- full graph
  integration, audit trail
- `test/flooringops/store_contract_test.cljk` -- Store protocol and
