...
1. Register operator, stores and vendors; independently confirm each
   ...
   seeding `flooringops.store`.
2. Import existing sales/inventory/return, installation-scheduling and
   supply-order history.
3. Run read-only sales-record-logging and installation-operation dry-runs
   (Phase 0-1).
